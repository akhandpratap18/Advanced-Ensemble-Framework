...
def upload_page():
    st.markdown(
    "<div style='text-align: center; font-size: 20px;'>🔒 Malware Detection Dashboard</div>",
    unsafe_allow_html=True
)
    st.sidebar.header("Model Selection")
    model_options = {
        'Android Malware': 'maldroid_model',
        'Windows Malware': 'pca_model',
        'IoMT WiFi Malware': 'iomt_model',
